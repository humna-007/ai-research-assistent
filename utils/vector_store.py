...
class VectorStore:
    ...
    def search(self, query_embedding: np.ndarray, top_k: int = 4, score_threshold: float = 0.3) -> list[dict]:
    ...
    def search_filtered(self, query_embedding: np.ndarray, source_names: set, top_k: int = 4, score_threshold: float = 0.3) -> list[dict]:
        matches = []
